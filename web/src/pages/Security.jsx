                ...
                >
                    ...
                    <div className="prose prose-blue max-w-none text-gray-600">
                        <p className="text-lg leading-relaxed mb-6">
                            Welcome to the CloudNest Security page. We are currently finalizing the detailed documentation for this section. Thank you for your patience as we prepare the official materials.
                        </p>
