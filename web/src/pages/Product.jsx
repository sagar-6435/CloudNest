    ...
    return (
        <div className="min-h-screen bg-gray-50 pt-20 pb-16">
            <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                >
                    <h1 className="text-4xl font-extrabold text-gray-900 mb-6">Product</h1>
                    <div className="prose prose-blue max-w-none text-gray-600">
                        <p className="text-lg leading-relaxed mb-6">
                            Welcome to the CloudNest Product page. We are currently finalizing the detailed documentation for this section. Thank you for your patience as we prepare the official materials.
                        </p>
